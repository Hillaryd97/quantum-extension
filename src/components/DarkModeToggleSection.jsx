...
const DarkModeToggleSection = () => {
  ...
  useEffect(() => {
    const interval = setInterval(nextSlide, 2000); // Change slide every 3 seconds (adjust as needed)
  ...
  return (
    <div>
      <div className="pt-32">
        ...
        <div className="grid lg:grid-cols-2 gap-28 py-32">
          <div>
          ...
          <div className="order-1 flex flex-col text-center md:text-left space-y-6 justify-center ">
            ...
            <p className="font-medium pr-20">
              ...
              immersive browsing with our Dark Mode extension. Delight in
              reduced eye strain and a visually pleasing interface on every
              webpage you visit
            </p>
          </div>
        </div>
        <div className="grid lg:grid-cols-2 gap-36 py-32">
          <div className="pl-[1rem] flex flex-col space-y-6 justify-center items-center">
            ...
            <p className="font-medium pl-16">
              Step into a realm of digital tranquillity. Experience browsing
              like never before with our Quantum Dark Mode—sleek, efficient, and
              easy on the eyes. Toggle on the Quantum Dark Mode effortlessly
              with a single click. Watch as webpages elegantly transition to a
              soothing dark theme, reducing eye strain and enhancing
              readability.
            </p>
          </div>
          <div>
        ...
        <div className="bg-quantum_500 text-white px-[10rem] pb-[7.5rem] flex flex-col space-y-8">
          <h3 className="text-4xl text-center pt-8 font-semibold">
            Our Mission
          </h3>
          <p className="text-justify text-xl">
            At Quantum Dark Mode, our mission is to redefine the digital
            experience by providing users with an immersive, eye-friendly
            browsing environment. We strive to transform the way people interact
            with technology, promoting a balance between aesthetics and
            well-being. Through our innovative dark mode solution, we aim to
            enhance readability, reduce eye strain, and ultimately empower users
            to embrace a harmonious digital lifestyle. We are committed to
